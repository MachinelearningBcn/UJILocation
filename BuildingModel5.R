...
WapSample <- read.csv("data/OnlyWapCut.csv", sep=",",header=TRUE,stringsAsFactors = FALSE)
...
WapSample$TIMESTAMP <- Dataset$TIMESTAMP
WapVal$TIMESTAMP <- vDataset$TIMESTAMP
...
#write.csv(WapVal,file="data/OnlyWapValBuilding.csv",row.names=FALSE)
